...
void Penguin::SequentialPatternUpdate(int _StartRange, int _PatternCount, int _PlusRange)
{
	...
	static int CurPatternCount = 0;
	int Range = _StartRange + CurPatternCount * _PlusRange - 1;


	if (_PatternCount > CurPatternCount)
	{
		++CurPatternCount;
	}
	else
