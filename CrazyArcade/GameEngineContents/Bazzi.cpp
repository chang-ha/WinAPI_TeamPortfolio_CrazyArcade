...
{
	BaseCharacter::Start();
	GlobalUtils::SpriteFileLoad("Bazzi_Ready.Bmp", "Resources\\Textures\\Character\\Bazzi\\", 18, 1);
	...
	MainRenderer->CreateAnimation("Bazzi_Ready", "Bazzi_Ready.Bmp", -1, -1, 0.1f, false);
	...
	MainRenderer->CreateAnimation("Bazzi_Live", "Bazzi_Live.Bmp", -1, -1, 0.1f, false);
